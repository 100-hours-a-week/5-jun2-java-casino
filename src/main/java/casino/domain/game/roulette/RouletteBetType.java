...
public enum RouletteBetType {
    ...
    COLUMN_BET(6, "세로로 일렬하는 12개 숫자에 동시 베팅", 2),
    DOZEN_BET(7, "레이아웃의 1st 12, 2nd 12, 3rd 12에 베팅", 2),
    HIGH_LOW_NUMBER_BET(8, "1 ~ 18 까지의 숫자 또는 19 ~ 36 까지의 숫자에 베팅", 1),
    EVEN_ODD_NUMBER_BET(9, "0을 제외한 모든 번호를 짝수와 홀수로 구분하여 베팅", 1),
    COLOR_BET(10, "0을 제외한 모든 번호를 적색과 흑색으로 구분하여 베팅", 1),
    NONE(0, "없음", 0);
    ...
    public static int getRouletteBetTypeSize() {
